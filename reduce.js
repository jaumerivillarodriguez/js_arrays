...
// const totalAges = students.reduce((total, student) => total + student.age, 0); //el valor empieza en 0;
...
const result = developers.reduce(function (allSkills, student) {
    return Array.from(new Set([...allSkills, ...student.skills])); //Set no duplica elemntos
}, []);
